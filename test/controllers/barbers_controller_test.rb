...
class BarbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barber" do
    assert_difference('Barber.count') do
      post barbers_url, params: { barber: { cpf: @barber.cpf, data_nascimento: @barber.data_nascimento, nome: @barber.nome, sobrenome: @barber.sobrenome, telefone: @barber.telefone } }
    end
  ...
  test "should update barber" do
    patch barber_url(@barber), params: { barber: { cpf: @barber.cpf, data_nascimento: @barber.data_nascimento, nome: @barber.nome, sobrenome: @barber.sobrenome, telefone: @barber.telefone } }
